...
public class Tank extends javax.swing.JFrame implements Vehicle{
    ...
    @Override
    public void sendmsg(){
        MainController.getInstant().recivemsg("Tank : - "+textField1.getText()+"\n");  
    }
    @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSpinner2, new org.netbeans.lib.awtextra.AbsoluteConstraints(422, 73, -1, -1));
        ...
        jSlider2.setValue(0);
        getContentPane().add(jSlider2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 18, -1, 331));
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(422, 29, -1, -1));
